...
class OperettaAcquisitionModel(BaseAcquisitionModel):
    ...
    For Operetta, this should be the base directory of the acquisition or the "{acquisition_dir}/Images" directory containing the tiff files and metadata.ome.xml file.
    """
